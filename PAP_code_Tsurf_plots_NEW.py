...
ax1.text(0.25, 0.75, 'LHS 1140 b', rotation=90, transform=ax1.transAxes,fontsize=17,color="midnightblue")
ax1.axvline(x=flux_to_axis(1368),color="dodgerblue",linewidth=2)
ax1.text(0.06, 0.18, 'K2-18b', rotation=90, transform=ax1.transAxes,fontsize=17,color="dodgerblue")
...
ax2.text(0.25, 0.75, 'LHS 1140 b', rotation = 90, transform=ax2.transAxes,fontsize=17,color="midnightblue")
ax2.axvline(x=flux_to_axis(1368),color="dodgerblue",linewidth=2)
ax2.text(0.06, 0.18, 'K2-18b', rotation=90, transform=ax2.transAxes,fontsize=17,color="dodgerblue")
...
ax1.text(0.46, 0.68, 'Habitable Zone', transform=ax1.transAxes,fontsize=21,fontweight='bold',color='lightseagreen')   
ax2.text(0.46, 0.68, 'Habitable Zone', transform=ax2.transAxes,fontsize=21,fontweight='bold',color='lightseagreen')   
...
for label,s,col,line in zip(labs1,strings1,colors1,linestyles):             # loop over concentrations for first gas
    ...
    ax3.plot(axis_adj[:-2], albedo[:-2], label=label, color=col, linewidth=2, linestyle=line)
...
#plt.savefig('/Users/new/Desktop/surface_temperatures_1bar_20bar_he_h2_NEW.png',dpi=750)
plt.show()
